...
function f6() {
    let inputKey = document.querySelector('.i-61').value,
        inputValue = document.querySelector('.i-62').value;
...
function f18() {
    let branchValue = document.querySelector('.i-18').value,
        out = '';

    for(let i = 0; i < a18[branchValue].length; i++) {
        out += a18[branchValue][i] + ' ';
    }
...
function f19() {
    let stationValue = capitalizeFirstLetter(document.querySelector('.i-19').value),
        out = '';

    for(let key in a19) {
        for(let i = 0; i < a19[key].length; i++) {
            if(a19[key][i] == stationValue) {
                out = key;
                break;
            }
        }
