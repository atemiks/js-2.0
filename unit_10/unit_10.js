...
// Выведите его в .out-1. 
// Вывод - по нажатию кнопки b-1

let ar1 = ['string', 10, 12, true, false];
...
let ar2 = ['string', 10, 12, true, false];
...
let ar3 = ['string', 10, 12, true, false];
...
// Task 5
// Создайте массив ar5 длина которого больше 5. 
// Выведите сумму нулевого, второго и третьего элементов массива (нуль, второй - и третий это индексы 0, 2, 3)
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
...
function f5() {
    document.querySelector('.out-5').innerHTML = ar4[0] + ar4[3] + ar4[8];
}
...
// Добавление элементов сделайте в f7. 
...
// Вывод последнего элемента  - реализуйте по индексу. 
...
function f11() {
    ...
    document.querySelector('.out-11').innerHTML = temp;
}
...
function f12() {
    ...
    document.querySelector('.out-12').innerHTML = temp;
}
...
function f13() {
    ...
    document.querySelector('.out-13').innerHTML = temp;
}
...
function f14() {
    ...
    document.querySelector('.out-14').innerHTML = temp;
}
...
function f15() {
    ...
    document.querySelector('.out-15').innerHTML = temp;
}
...
function f16() {
    ...
    document.querySelector('.out-16-even').innerHTML = temp_even;
    document.querySelector('.out-16-odd').innerHTML = temp_odd;
}
