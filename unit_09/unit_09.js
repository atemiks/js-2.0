...
//  Task 5
// По нажатию .b-5 запускайте функцию f5, которая проверяет наличие класса .bg-orange у блока .out-4 (да, именно у out-4 ). 
...
function f6() {
    document.querySelector('.out-6').innerHTML = document.querySelectorAll('p.p-6').length;
}
...
// С помощью цикла повесим на блоки .out-9 событие клик. 
...
//  Task 11
// Кнопка .b-11, запускает функцию f11. 
// Функция создает через createElement div c текстом 25 и добавляет его через append в .out-11.


function f11() {
    let container = document.querySelector('.out-11');

    let createdElement = document.createElement('div');
    createdElement.innerHTML = '25';
...
function f12() {
    let container = document.querySelector('.out-12');

    let createdElement = document.createElement('div');
    createdElement.innerHTML = '12';
    createdElement.classList.add('bg-12');
    container.appendChild(createdElement);
}
...
function f13() {
    let container = document.querySelector('.out-13');

    let createdElement = document.createElement('div');
    createdElement.innerHTML = 'pushMe';
    createdElement.classList.add('bg-orange');
    createdElement.onclick = f13_1;
    container.appendChild(createdElement);
}
...
function f14() {
    let container = document.querySelector('.out-14');

    let createdElement = document.createElement('div');
    createdElement.innerHTML = '14';
    createdElement.classList.add('bg-orange');
    container.appendChild(createdElement);
}
...
function f15() {
    let container = document.querySelector('.out-15');

    let createdElement = document.createElement('div');
    createdElement.innerHTML = '15';
    createdElement.classList.add('bg-orange');
    container.before(createdElement);
}
...
function f16() {
    let container = document.querySelector('.out-16');

    let createdElement = document.createElement('div');
    createdElement.innerHTML = '16';
    createdElement.classList.add('bg-orange');
    container.after(createdElement);
}
...
function f17() {
    let container = document.querySelector('.out-17');

    let createdElement = document.createElement('div');
    createdElement.innerHTML = '17';
    createdElement.classList.add('bg-orange');
    container.replaceWith(createdElement);
}
...
function f19() {
    let blocks = document.querySelectorAll('.p-19'),
        temp = '';

    for(let i = 0; i < blocks.length; i++) {
        temp += blocks[i].getAttribute('data-b') + ' ';
    }

    document.querySelector('.out-19').innerHTML = temp;
}
