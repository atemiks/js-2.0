...
// Task 1
// Создайте set s1. 
// Добавьте в него три элемента 'h', 'b', 'o', 'h'. 
...
// Если строка есть - то вывести в out-4 true. 
// Если нет - false.
...
const f4 = () => {
    ...
    out.innerHTML = s4.has(input.value);
}
...
const f7 = () => {
    let input = document.querySelector('.i-7')
        ...
        s7 = new Set(input.value);

    console.log(s7);


    s7.size > 6 ? out.innerHTML = 1 : out.innerHTML = 0;
}
...
// Функция должна преобразовать массив a11 в набор. И выводить в консоль. 
// Изучите вывод получившегося набора. 
...
const f12 = () => {
    let strArray = str12.split(''),
        strSet = new Set(strArray);
...
const f13 = () => {
    ...
    for(let item of strSet) {
        ...
        for(let i = 0; i < strArray.length; i++ ) {
            if(item == strArray[i]) {
                strSymbolsRepeat[item] = ++counter;
            }
        }
    }

    return strSymbolsRepeat;
}
