// Task 1
// При нажатии (click) на .b-1 запускайте f1, 
// которая выводите в .out-1 число 1.
...
// Task 2
// При нажатии (click) на .i-2 запускайте f2, 
// которая выводите в .out-2 число 2. 
...
// Task 3
// При нажатии (click) на .p-3 запускайте f3, 
// которая выводите в .out-3 число 3. 
...
// Функция проверяет состояние .i-4 и если он checked - выводит true, 
// если не выбран - false. 
// Вывод везде в задачах, где не указано другое, 
// осуществляется в div.out-номер задачи. 
...
// Функция проверяет состояние .i-5 и если он checked 
// - выводит value данного элемента, если не выбран - false. 
// Вывод везде в задачах, где не указано другое, 
// осуществляется в div.out-номер задачи. 
...
// Функция с помощью innerHTML создает в .out-8 новый div 
// с классом "js2" и текстом "new div". 
// Нажали несколько раз? 
// Создаем несколько раз!
...
function f9() {
    ...
    if(radioButton.checked) {
        out.innerHTML = radioButton.value;
    } else {
        out.innerHTML = false;
    }
}
...
// Функция получает из .i-10 значение цвета 
// и окрашивает style.background элемента .out-10 в этот цвет.
...
// Task 12
// При нажатии кнопки .b-12 запускается функция f12. 
// Функция выводит дату из .i-12 в out-12.
...
// Task 15
// При нажатии кнопки .b-15 функция должна 
// выводить текст из .i-15 в textarea .t-15 и в .out-15.

function f15() {
    let input = document.querySelector('.i-15'),
        textarea = document.querySelector('.t-15'),
...
// Task 18
// При смене выбранного значения в s-18, 
// получайте из него value выбранного option 
// и присвойте данный value в input .i-18.
...
// Task 19
// На странице создан div.out-19. 
// По нажатию кнопки, получите из него текст 
...
// Task 20
// У вас есть два select. 
// Напишите код, который при изменении select .s-201 
// будет аналогично изменять выбранный option в .s-202.

function f20() {
    let select1 = document.querySelector('.s-201'),
        select2 = document.querySelector('.s-202');
